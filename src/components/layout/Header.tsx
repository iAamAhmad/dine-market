...
import { navLink } from "@/components/utills/navData";
        ...
        <div
          ...
          <div className='relative flex '>
            <input
              ...
              className='w-60 h-10 pl-4 pr-12 rounded-lg bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400 text-black'
            />
            <div className='absolute right-3 top-1/2 transform -translate-y-1/2 md:transition-all'>
